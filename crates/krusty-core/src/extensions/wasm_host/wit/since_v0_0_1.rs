//! WIT bindings for extension API v0.0.1
...
wasmtime::component::bindgen!({
    ...
    path: "src/extensions/wit/since_v0.0.1",
    with: {
...
impl From<LanguageServerInstallationStatus> for latest::LanguageServerInstallationStatus {
    fn from(value: LanguageServerInstallationStatus) -> Self {
        match value {
            ...
            LanguageServerInstallationStatus::Downloaded => Self::None, // No direct equivalent
            LanguageServerInstallationStatus::Downloading => Self::Downloading,
            LanguageServerInstallationStatus::Cached => Self::None, // No direct equivalent
