//! WIT bindings for extension API v0.6.0
...
wasmtime::component::bindgen!({
    ...
    path: "src/extensions/wit/since_v0.6.0",
    with: {
...
// Conversions to latest types

// Command is shared via zed:extension/process, so no conversion needed
...
// Host trait implementations - delegate to latest
